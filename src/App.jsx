...
const phases = [
  ...
  { n: "02", t: "Launch", d: "Token issuance completed · Liquidity provisioning · Initial brand campaigns" },
  { n: "03", t: "Expansion", d: "International community growth · Content strategy · Strategic partnerships" },
  { n: "04", t: "Brand Experience", d: "NFT and membership · Merchandise · K-culture collaborations" },
  { n: "05", t: "Long-term Ecosystem", d: "Community consolidation · Brand assets · Global K-crypto positioning" },
];
    ...
    <div style={{ background: "#060a16", color: "#f0ece2", minHeight: "100vh" }}>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero-mint:hover .hero-mint-copy {
          opacity: 1;
      ...
      <nav
        className={`nav ${scrollY > 60 ? "scrolled" : ""}`}
      ...
      <section className="hero" id="top">
        <FadeIn delay={0.3}>
          <img src={LOGO} alt="Geobukseon" className="hero-logo" />
        </FadeIn>
        ...
        <FadeIn delay={0.8}>
          <p className="hero-quote">
            "I still have twelve warships under my command."
            <br />
        ...
        <FadeIn delay={1.0}>
          <p className="hero-tagline">
            ...
            Culture in Motion.
            <br />
            A K-Crypto Brand for the World.
          </p>
        </FadeIn>
      ...
      <section style={{ background: "linear-gradient(175deg, #0d1225, #080d1c)" }} id="manifesto">
        <div className="section">
          ...
          <FadeIn delay={0.1}>
            <p className="body">
              The Geobukseon was a symbol of order imposed upon chaos — a future carved from an overwhelming present.{" "}
              <strong>Geobukseon Coin revives this symbol,</strong> translating Korea&apos;s historical depth into a digital asset brand for the world.
            </p>
          </FadeIn>
      ...
      <section style={{ background: "linear-gradient(175deg, #0d1225, #080d1c)" }}>
        <div className="section">
          ...
          <FadeIn delay={0.1}>
            <p className="body">
              K is no longer a regional code.{" "}
              <strong>Geobukseon Coin extends Korea&apos;s cultural momentum into digital assets</strong> — carrying historical density in a form the world can read.
            </p>
          </FadeIn>
      ...
      <section style={{ background: "linear-gradient(175deg, #0d1225, #080d1c)" }} id="roadmap">
        <div className="section">
          ...
          <div style={{ marginTop: "10px", maxWidth: "700px" }}>
            {phases.map((p, i) => (
              <FadeIn key={i} delay={0.06 + i * 0.06}>
                <div className="phase">
                  ...
                  {i < phases.length - 1 ? <div className="phase-line" /> : null}
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section
        style={{
          background: "linear-gradient(175deg, #080d1c, #060a16)",
          padding: "110px 24px",
          textAlign: "center",
        }}
      >
        <FadeIn>
          <img
            ...
            style={{
              ...
              opacity: 0.35,
              marginBottom: 36,
              filter: "drop-shadow(0 0 20px rgba(196,162,101,0.08))",
            }}
          />
        </FadeIn>
        ...
        <FadeIn delay={0.12}>
          ...
          >
            It starts in Korea.
            <br />
            It expands to the world.
            <br />
            And it does not sink easily.
          </p>
        </FadeIn>
